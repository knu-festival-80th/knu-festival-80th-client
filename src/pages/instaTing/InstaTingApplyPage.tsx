...
const InstaTingApplyPage = () => {
  const {
    register,
    handleSubmit,
    control,
    formState: { errors },
  } = useForm<FormValues>({ defaultValues: { gender: 'male' } });
  ...
  return (
    <>
      {/* Form */}
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-7 px-5 py-6 bg-white">
        {/* Header */}
        ...
        <button
          type="submit"
          className="h-[50px] w-full rounded-md bg-sub-red font-wanted-sans text-body1 font-medium tracking-tight text-surface"
        >
          인스타팅 신청하기
        </button>
...
export default InstaTingApplyPage;
