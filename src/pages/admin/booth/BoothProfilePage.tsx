...
function BoothProfileForm({ boothId, initial }: BoothProfileFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <h2 className="text-subheading font-semibold text-text">부스 정보 수정</h2>
      ...
      <button
        ...
        className="self-start rounded-md bg-primary px-4 py-2 text-body1 font-semibold text-surface transition hover:opacity-90 disabled:opacity-60"
      >
