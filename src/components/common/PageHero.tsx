...
export default function PageHero({ title }: PageHeroProps) {
  return (
    <div
      className="relative flex min-h-[270px] flex-col justify-end overflow-hidden py-[42px]"
    ...
    >
      ...
      />
      <div className="relative mx-auto w-full max-w-[375px] px-5">
        <p className="font-wanted-sans text-display1 font-bold leading-[1.4] tracking-[-0.02em] text-ink">
          {title}
        </p>
      </div>
    </div>
